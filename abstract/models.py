...
class PaperAbstract(models.Model):
	...
	def send_email(self):
		context = {
			...
			'content'     : f"New Abstract {self.title}, Submitted  by {self.user.first_name} {self.user.email} use the link to download the file https://iconmat2025.cusat.ac.in{self.abstract.url} ",
